...
//  TWBR = 12;  // 400 kbit/sec I2C speed
  ...
  Wire.begin(I2C_MASTER, 0x00, I2C_PINS_7_8, I2C_PULLUP_EXT, I2C_RATE_400);
  Serial.begin(115200);
...
{  
 ...
 // gz = (int)gyroCount[2];//*gRes;  
    Serial.print(az); Serial.print(" ");Serial.print(ay);Serial.print(" ");Serial.print(az); Serial.print(" ");
    //Serial.print(gz); Serial.print(" ");Serial.print(gy);Serial.print(" ");Serial.println(gz);
