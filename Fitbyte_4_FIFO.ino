...
//  TWBR = 12;  // 400 kbit/sec I2C speed
 ...
 // Wire.begin(I2C_MASTER, 0x00, I2C_PINS_16_17,  I2C_PULLUP_EXT, I2C_RATE_1200); // Strong signal - 35,000
 // Wire.begin(I2C_MASTER, 0x00, I2C_PINS_18_19,  I2C_PULLUP_EXT, I2C_RATE_1500); // Strong signal - 35,000
 ...
 // Wire.begin(I2C_MASTER, 0x00, I2C_PINS_16_17,  I2C_PULLUP_EXT, I2C_RATE_1500); // Strong signal - 35,000
  ...
  Wire2.begin(I2C_MASTER, 0x00, I2C_PINS_3_4,  I2C_PULLUP_EXT, I2C_RATE_1500);
...
if (deviceID != 0x186)
 ...
 // acceleTimer.begin(mainFun, 25000);  //4KHz
  gyroTimer.begin(readGyros, 20000);  //50Hz
  camOnTimer.begin(pullDownCam, 1000000); //1Hz
  camOffTimer.begin(pullUpCam, 333333 ); //1Hz

  //setting priorities
 // acceleTimer.priority (0);  
...
// Comment - Lynn
  ...
  if (readByte1(MPU9250_ADDRESS, INT_STATUS) >= 0x00) 
  {  
    ...
    {
    printBuffer[Accelcount]=fifoData[i];
...
//  Serial.print(" 1 ");
    ...
    ////prox
//Wire2.pinConfigure(I2C_PINS_3_4, I2C_PULLUP_INT);
////Serial.println("prox1");
// Wire2.beginTransmission(SAD);
//  Wire2.write(commandreg);
//  Wire2.write(0xC8);
...
//
// /////////////////////////////////////////////////////
//  Wire2.requestFrom(SAD, 2);
//  while(Wire2.available()){
//    upperByte = Wire2.read();
//    lowerByte = Wire2.read();
//    prox = ((upperByte<<8)|lowerByte);
//  }
//  prox=123;
//  if (SDcard)
// dataFile.print(prox);
...
///////////////wire 1
  if (readByte2(MPU9250_ADDRESS, INT_STATUS) & 0x01) {
  readGyroData2(gyroCount);  // Read the x/y/z adc values
...
/////////// Wire0
  ...
  Wire.pinConfigure(I2C_PINS_47_48, I2C_PULLUP_EXT);
...
//  }
 ...
 //Wire.pinConfigure(I2C_PINS_33_34, I2C_PULLUP_EXT);

 if (readByte(MPU9250_ADDRESS, INT_STATUS) & 0x01) {  // On interrupt, check if data ready interrupt

  // Reading from the 1st IMU
  readGyroData(gyroCount);  // Read the x/y/z adc values
...
//  Read from the VCNL Prox Sensor
  int distance = readFromCommandRegister(PS_DATA_L); //Get proximity values
 // int distance = 111; //Get proximity values
...
for(int i=0;i<bufSize;i++)
   {
//    if (SDcard) {
      dataString += String(printBuffer[i]);
     dataString += String(" "); 
     //dataFile.print(printBuffer[i]);
     //dataFile.print(",");
//     }
//     if (serial) {
//     Serial.print(printBuffer[i]);
//     Serial.print(" ");}
     printBuffer[i]=0;// clear buffer

     
  
   }
  //dataString += String(printBuffer[bufSize-1]);
  //printBuffer[bufSize-1]=0;
  
  dataString += String(Accelcount);
